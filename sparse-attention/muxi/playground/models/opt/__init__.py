...
"""
from .modeling_opt import OPTModel, OPTModel_use_block_sparse_attention_lut

OPTModel.use_block_sparse_attention_lut = OPTModel_use_block_sparse_attention_lut
