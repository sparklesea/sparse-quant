...
def run_flexgen(args):
    ...
    # inputs = get_dataset_inputs(prompt_len, num_prompts, tokenizer, dataset)
    ...
    for prompt_len in [8, 16, 32, 64, 128]:
        num_prompts = args.num_gpu_batches * args.gpu_batch_size
        gen_len, cut_gen_len = args.gen_len, args.cut_gen_len
        ...
        print(f"prefill size: {prompt_len}, decode latency: {decode_latency*1000:.2f} ms, decode_throughput: {decode_throughput:.2f} tokens/s")
    env.close_copy_threads()

def add_parser_arguments(parser):
    parser.add_argument("--model", type=str, default="facebook/opt-6.7b",
        help="The model name.")
    parser.add_argument("--path", type=str, default="/share/huangshan/opt_weights",
