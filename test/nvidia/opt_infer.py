...
if __name__ == "__main__":
    ...
    # CUDA_VISIBLE_DEVICES=6 python opt_infer.py --model_path $MODEL_OPT_PATH --w_bit 4 --output_path quantized_model/opt

    # then run
    # CUDA_VISIBLE_DEVICES=6 python opt_infer.py --model_path quantized_model/opt --lut_path /share/huangshan/masks/opt_lut_density_26.pt --w_bit 4 --quantized
    main()
