...
class BERTQuantizer(RTNQuantizer):
    def __init__(self, w_bit=16, a_bit=16, kv_bit=16, w_group_size=128, a_group_size=128, kv_group_size=128, w_granularity="per_group", a_granularity="per_token", kv_granularity="per_group", w_zero_point=True, a_zero_point=False, kv_zero_point=True, fake_quant=False):
