...
from utils.quant_funcs import pseudo_quantize_tensor, quant_nvidia
...
class WALinear(nn.Module):
    ...
    def from_float(module, w_config, a_config, quantize_output=False):
        ...
        new_module.weight, new_module.zeros_scales = quant_nvidia(module.weight, module.in_features, module.out_features,
