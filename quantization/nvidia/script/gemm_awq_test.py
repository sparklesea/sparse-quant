...
if 'NVIDIA' in device_name:
    ...
    raise Exception(f"Unsupported device {device_name}")

if device_name == 'NVIDIA':
    from quant_dequant_nvidia import quant_lmdeploy as quant_func
    
elif device_name == 'AMD':
    from quant_dequant_amd import quant_amd as quant_func

from inficom import gemm_awq_ut, gemm_awq_residual_ut, gemm_awq_silu_dot_ut
...
Seqlens = [1, 128]
Batchsizes = [1, 2, 4, 8, 16, 32, 48, 64]
