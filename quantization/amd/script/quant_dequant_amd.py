...
def quant_amd(weight, input_features, output_features, group_size):
    qweight, zeros_scales = generate_quant_amd(weight, input_features, group_size)
    ...
    qweight, zeros_scales = generate_quant_amd(reformat_weight, input_features, group_size)
...
def generate_quant_amd(weight_fp16, input_features, group_size):
    ...
    qweight_temp, scales_temp, zeros_temp = quantize_tensor_amd(weight_fp16[:, :end], 4, group_size)
