...
__device__ __forceinline__ T blockReduceSum_blockdimx_128(T reducing,
  ...
  // reducing += __shfl_down_sync(FULLMASK, reducing, 32, WARP_SIZE);
  // reducing += __shfl_down_sync(FULLMASK, reducing, 16, WARP_SIZE);
  // reducing += __shfl_down_sync(FULLMASK, reducing, 8, WARP_SIZE);
  // reducing += __shfl_down_sync(FULLMASK, reducing, 4, WARP_SIZE);
  // reducing += __shfl_down_sync(FULLMASK, reducing, 2, WARP_SIZE);
  // reducing += __shfl_down_sync(FULLMASK, reducing, 1, WARP_SIZE);
