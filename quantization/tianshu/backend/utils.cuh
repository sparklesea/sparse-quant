...
__device__ __forceinline__ T blockReduceSum_blockdimx_128(T reducing,
  ...
  // reducing += __shfl_xor_sync(FULLMASK, reducing, 32);
  // reducing += __shfl_xor_sync(FULLMASK, reducing, 16);
  // reducing += __shfl_xor_sync(FULLMASK, reducing, 8);
  // reducing += __shfl_xor_sync(FULLMASK, reducing, 4);
  // reducing += __shfl_xor_sync(FULLMASK, reducing, 2);
  // reducing += __shfl_xor_sync(FULLMASK, reducing, 1);

  reducing += __shfl_down_sync(FULLMASK, reducing, 32);
  reducing += __shfl_down_sync(FULLMASK, reducing, 16);
  reducing += __shfl_down_sync(FULLMASK, reducing, 8);
  reducing += __shfl_down_sync(FULLMASK, reducing, 4);
  reducing += __shfl_down_sync(FULLMASK, reducing, 2);
  reducing += __shfl_down_sync(FULLMASK, reducing, 1);
